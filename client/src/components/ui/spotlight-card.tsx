...
interface SpotlightCardProps {
  children: ReactNode;
  className?: string;
  glowColor?: 'navy' | 'maroon' | 'gold' | 'blue' | 'purple';
  size?: 'sm' | 'md' | 'lg' | 'auto';
  width?: string | number;
...
const glowColorMap = {
  navy: { base: 220, spread: 40 },
  maroon: { base: 350, spread: 30 },
  gold: { base: 40, spread: 30 },
  ...
  return (
    <>
      ...
      <div
        ...
        className={cn(
          getSizeClasses(),
          "rounded-3xl relative overflow-hidden shadow-soft backdrop-blur-sm",
          className
        )}
      >
